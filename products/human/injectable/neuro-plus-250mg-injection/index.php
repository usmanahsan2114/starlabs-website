                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/injectable/neuro-plus-250mg-injection.png" alt="Neuro Plus 250mg Injection - Human Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Neuro Plus 250mg Injection</h1>
                                        </div>
                                        <p>For the treatment of depression, schizophrenia, stroke, Parkinson disease, brain injury, and cognitive deficits</p>
