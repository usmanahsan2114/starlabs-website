                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/injectable/moxistar-infusion-400mg-injection.jpg" alt="Moxistar Infusion 400mg/250ml - Human Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Moxistar Infusion 400mg/250ml</h1>
                                        </div>
                                        <p>To treat bacterial infections in many different parts of the body</p>
