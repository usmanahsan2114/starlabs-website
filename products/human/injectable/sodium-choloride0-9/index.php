                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/injectable/sodium-choloride.jpg" alt="Sodium Choloride0.9% - Human Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Sodium Choloride0.9%</h1>
                                        </div>
                                        <p> To replenish lost water and salt in your body due to certain conditions (eg, hyponatremia or low salt syndrome) </p>
