                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/injectable/staflox-500mg-injection.png" alt="Staflox Injection 500mg - Human Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Staflox Injection 500mg</h1>
                                        </div>
                                        <p> To treat infections such as pneumonia; and kidney, prostate (a male reproductive gland), and skin infections </p>
