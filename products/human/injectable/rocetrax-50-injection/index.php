                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/injectable/rocetrax-50-injection.png" alt="Rocetrax-50 Injection - Human Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Rocetrax-50 Injection</h1>
                                        </div>
                                        <p> Treatment of bacterial infections in various locations, such as in the respiratory tract, skin, soft tissue, and urinary tract. </p>
