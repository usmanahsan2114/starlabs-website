                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/injectable/meglutin-injection.jpg" alt="Meglutin 30% Injection - Human Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Meglutin 30% Injection</h1>
                                        </div>
                                        <p>To treat an infection called leishmaniasis (Bay sore or chiclero ulcer, espundia, kala-azar or black sickness, Oriental sore, ulcera de Bejuco, uta)</p>
