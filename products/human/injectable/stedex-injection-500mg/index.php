                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/injectable/stedex-500gm-injection.jpg" alt="Stedex Injection 500 mg - Human Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Stedex Injection 500 mg</h1>
                                        </div>
                                        <p> Bacterial infections of the lower respiratory tract, infections of the urinary tract, infections of the bones, joints, skin, soft tissues, and abdominal infections </p>
