                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/injectable/amicin-250mg-injection.png" alt="Amicin 250mg Injection - Human Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            <p style="color:#db0000;"> <b>Human</b> ~ Injectables</p>
                                            <h1>Amicin 250mg Injection</h1>
                                        </div>
                                        <p> Amikacin injection is used to treat certain serious infections that are caused by bacteria such as meningitis (infection of the membranes that surround the brain and spinal cord) and infections of the blood, abdomen (stomach area), lungs, skin, bones, joints, and urinary tract </p>
