                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/injectable/stibotim-injection.jpg" alt="Stibotim Injection - Human Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Stibotim Injection</h1>
                                        </div>
                                        <p> Used to treat cutaneous, visceral, and mucosal leishmaniasis, a parasitic infection transmitted by sand-fly bites. </p>
