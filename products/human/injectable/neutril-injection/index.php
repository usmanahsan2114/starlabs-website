                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/injectable/neutril-injection.jpg" alt="Neutril Injection - Human Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Neutril Injection</h1>
                                        </div>
                                        <p> For Alzheimer's disease, dementia, memory dysfunction, alcoholism, Raynaud's phenomenon, deep vein thrombosis (DVT), stroke, tardive dyskinesia, dyslexia, brain injury, and vertigo</p>
