                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/injectable/adenofort-injection-100mcg.jpg" alt="Adenofort Injection 1000 mcg - Human Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Adenofort Injection 1000 mcg</h1>
                                        </div>
                                        <p> To treat Neuritis and neuralgia, especially cervical syndrome, shoulder-arm syndrome, lumbalgia, sciatica, facial paresis. Alcoholic polyneuropathy. Diabetic neuropathy, including impotence due to autonomic neuropathy.</p>
