                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/injectable/anvil-injection.jpg" alt="Anvil Injection - Human Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Anvil Injection</h1>
                                        </div>
                                        <p> To treat symptoms of allergic conditions such as drug rashes, hay fever, serum sickness, food allergy, allergic conjunctivitis, angioneurotic oedema (swelling under the skin) and itching skin conditions. </p>
