                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/ziptrin-tablets.jpg" alt="Ziptrin Tablets - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Ziptrin Tablets</h1>
                                        </div>
                                        <p>A vitamin supplement that helps improve the health of the nervous system, improves metabolism, strengthens the immune system, maintains healthy skin/hair, enhances red blood cell production</p>
