                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/nidagyl-tablets-400mg.jpg" alt="Nidagyl Tablets 400 mg - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Nidagyl Tablets 400 mg</h1>
                                        </div>
                                        <p>To treat infections of the reproductive system, gastrointestinal (GI) tract, skin, heart, bone, joint, lung, blood, nervous system, and other areas of the body.</p>
