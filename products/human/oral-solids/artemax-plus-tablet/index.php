                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/artemax-plus-tablets.jpg" alt="Artemax Plus Tablet - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Artemax Plus Tablet</h1>
                                        </div>
                                        <p> Is used to treat acute, uncomplicated malaria in patients 2 months of age and older who weigh at least 5 kilograms (kg). It may be used to treat malaria infections in areas or regions where it is known that other medicines (eg, chloroquine) may not work. </p>
