                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/diclogin-plus-tablet.jpg" alt="Diclogin Plus Tablet - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Diclogin Plus Tablet </h1>
                                        </div>
                                        <p> Diclofenac is a nonsteroidal anti-inflammatory drug (NSAID) used to relieve symptoms of arthritis such as inflammation, swelling, stiffness, and joint pain. Misoprostol is used to decrease the risk of having stomach and bowel ulcers.</p>
