                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/diflustar-capsules-150mg.jpg" alt="Diflustar Capsules 150 mg - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Diflustar Capsules 150 mg</h1>
                                        </div>
                                        <p>  To treat infections caused by fungi and may also be used to stop you from getting a candida infection.</p>
