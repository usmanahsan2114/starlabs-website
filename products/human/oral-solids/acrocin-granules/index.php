                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/acrocin-granules.jpg" alt="Acrocin Granules - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Acrocin Granules</h1>
                                        </div>
                                        <p> To treat a wide variety of bacterial infections. It may also be used to
                                            prevent certain bacterial infections. Erythromycin is known as a
                                            macrolide antibiotic</p>
