                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/apsar-tablet-150mg.jpg../../../../img/shop/img3.jpg" alt="Apsar Tablets 150 mg - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Apsar Tablets 150 mg</h1>
                                        </div>
                                        <p> Indigestion, heartburn and acid reflux, gastro-oesophageal reflux disease (GORD – this is when you keep getting acid reflux), and to prevent and treat stomach ulcers</p>
