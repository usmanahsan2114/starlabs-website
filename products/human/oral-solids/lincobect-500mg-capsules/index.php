                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/lincobect-500mg-capsules.jpg" alt="Lincobect 500 mg Capsules - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Lincobect 500 mg Capsules</h1>
                                        </div>
                                        <p> To treat severe bacterial infections in people who cannot use penicillin antibiotics.</p>
