                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/montel-sachet-4mg.jpg" alt="Montel Sachet 4mg - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Montel Sachet 4mg</h1>
                                        </div>
                                        <p>Montelukast sodium is a leukotriene receptor antagonist used in the treatment of asthma and allergic rhinitis. It works by blocking the action of leukotrienes, which are substances in the body that cause inflammation and allergic reactions</p>
