                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/dicpot-tablet.png" alt="Dicpot Tablets - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Dicpot Tablets</h1>
                                        </div>
                                        <p>  To relieve mild to moderate pain and swelling (inflammation) from various conditions such as headache, dental pain, menstrual cramps, and muscle aches</p>
