                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/mygaba-300mg.jpg" alt="Mygaba 300mg Capsule - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Mygaba  300mg Capsule</h1>
                                        </div>
                                        <p>Pregabalin is a medication that treats nerve pain by calming overactive nerves in your body. It can also treat epilepsy by preventing and managing seizures</p>
