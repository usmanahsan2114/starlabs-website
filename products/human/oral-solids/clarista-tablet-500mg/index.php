                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/clarista-tablet-500mg.png" alt="Clarista Tablet 500 mg - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Clarista Tablet 500 mg</h1>
                                        </div>
                                        <p> To treat chest infections such as pneumonia, skin problems such as cellulitis, and ear infections </p>
