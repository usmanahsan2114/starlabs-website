                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/residol-cf-tablets.jpg" alt="Residol C.F Tablets - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Residol C.F Tablets</h1>
                                        </div>
                                        <p>Helps relieve symptoms of cold and flu such as headache, sore throat, runny nose, muscular pain, and fever
                                        </p>
