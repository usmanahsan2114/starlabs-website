                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/reyan-capsules-400mg.png" alt="Reyan Capsules 400 mg - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Reyan Capsules 400 mg</h1>
                                        </div>
                                        <p>Bactericidal against a number of bacteria causing pharyngitis, tonsillitis, bronchitis, pneumonia, otitis media, nephritis, typhoid, dysentery</p>
