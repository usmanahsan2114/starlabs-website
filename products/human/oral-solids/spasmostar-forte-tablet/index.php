                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/spasmostar-forte-tablet.jpg" alt="Spasmostar forte Tablet - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Spasmostar forte Tablet</h1>
                                        </div>
                                        <p>To treated and relieve smooth muscle spasms i.e. Is seen in menstrual pain, abdominal pain, pain due to kidney stone and biliary stone and gastrointestinal colicky pain</p>
