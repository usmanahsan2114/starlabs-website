                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/alfasta-tablets-0.25mcg.jpg" alt="Alfasta Tablet 0.25mcg - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Alfasta Tablet 0.25mcg</h1>
                                        </div>
                                        <p> Alfacalcidol is used in the treatment of vitamin D deficiency in patients with metabolic conditions including: low blood calcium and phosphate levels, kidney disease, parathyroid disease, rickets, or rickets. Osteoporosis</p>
