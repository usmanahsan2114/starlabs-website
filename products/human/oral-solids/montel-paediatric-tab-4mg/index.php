                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/montel-paediatric-tab-4mg.jpg" alt="Montel Paediatric Tab 4mg - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Montel Paediatric Tab 4mg</h1>
                                        </div>
                                        <p>To prevent wheezing, difficulty breathing, chest tightness, and coughing caused by asthma in adults and children 12 months of age and older</p>
