                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/emazole-40mg-capsule.jpg" alt="Emazole 40 mg Capsule - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Emazole 40 mg Capsule</h1>
                                        </div>
                                        <p>  Treats heartburn, stomach ulcers, reflux disease, or other conditions that cause too much stomach acid</p>
