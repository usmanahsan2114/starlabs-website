                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/diclogin-sr-100-tablet.jpg" alt="Diclogin-SR 100 Tablets - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            <p style="color:#db0000;"> <b>Human</b> ~ Oral Solids</p>
                                            <h1>Diclogin-SR 100 Tablets </h1>
                                        </div>
                                        <p> Relieve pain, reduce swelling and ease inflammation in conditions affecting the joints, muscles and tendons including:
                                        Rheumatoid arthritis, osteoarthritis, acute gout (painful inflammation of the joints especially in the feet and hands), ankylosing spondylitis (form of spinal arthritis).</p>
