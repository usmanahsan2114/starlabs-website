                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-solid/montel-tablet-400mg.jpg" alt="Moxistar Tablet 400mg - Human Oral Solids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Moxistar Tablet 400mg</h1>
                                        </div>
                                        <p>To treat certain infections caused by bacteria such as pneumonia, and skin, and abdominal (stomach area) infections</p>
