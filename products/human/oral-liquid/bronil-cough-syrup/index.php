                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-liquid/bronil-cough-syrup.png" alt="Bronil Cough Syrup - Human Oral Liquids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            <p style="color:#db0000;"> <b>Human</b> ~ Oral Liquis</p>
                                            <h1>Bronil Cough Syrup</h1>
                                        </div>
                                        <p> For an effective control of all coughs associated with Nasal Allergy, Bronchial Spasm, Congestion, Asthmatic Cough, Bronchitis & Respiratory Tract Congestion.</p>
