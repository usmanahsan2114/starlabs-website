                            ...
                            <div class="row">
                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-liquid/picolax-drops.jpg" alt="Picolax Drops - Human Oral Liquids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        ...
                                        <p> To clean out the intestines before surgery or certain procedures</p>
