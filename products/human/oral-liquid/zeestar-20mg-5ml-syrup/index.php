                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/oral-liquid/zeestar-20mg-5ml-syrup.jpg" alt="Zeestar 20mg/5ml syrup - Human Oral Liquids by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Zeestar 20mg/5ml syrup </h1>
                                        </div>
                                        <p>It reduces the severity and duration of diarrhea episodes, replenishes the body's zinc reserves and has a preventive action for up to three months after treatment</p>
