                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/human/topical/seplon-concentrated-solution.jpg" alt="Seplon Concentrated Solution - Human Topical by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            <p style="color:#db0000;"> <b>Human</b> ~ Topical</p>
                                            <h1>Seplon Concentrated  Solution</h1>
                                        </div>
                                        <p> They kill infectious microorganisms and effectively clean out cuts and wounds.</p>
