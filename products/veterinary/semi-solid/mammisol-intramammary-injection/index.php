                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/semi-solid/mammisol-intramammary-injection.jpg" alt="Mammisol Intramammary Injection - Veterinary Semi-Solid Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Mammisol Intramammary Injection</h1>
                                        </div>
                                        <p>For intra mammary treatment of hovine and gram-negative organisms. </p>
