                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/semi-solid/mastigon-intramammary-ointment.jpg" alt="Mastigon Intramammary Ointment - Veterinary Semi-Solid Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Mastigon Intramammary Ointment</h1>
                                        </div>
                                        <p>Short-term treatment of severe infections caused by susceptible strains </p>
