                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/semi-solid/rasomycin-i/m-injection.jpg" alt="Rasomycin I/M injection - Veterinary Semi-Solid Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            <p style="color:#db0000;"> <b>Veterinary</b> ~ Semi Solid</p>
                                            <h1>Rasomycin I/M injection</h1>
                                        </div>
                                        <p>Rasomycin is broad spectrum antibiotic with a bacteriostatic action against both gram-positive and gram-negative micro-organisms and furthermore rickettsiae, mycroplasma, chlamydia, some typical mycobacteria and amoebae.</p>
