                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/rasomycin-5.png" alt="rasomycin 5 Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>rasomycin 5 Injection </h1>
                                        </div>
                                        <p>Rasomycin is broad spectrum antibiotic with a bacteriostatic action against both gram-positive and gram-negative micro-organisms and furthermore rickettsiae, mycroplasma, chlamydia, some typical mycobacteria and amoebae. The bacteriostatic effect is based on the inhibition of glutaminic acid metabolism in the cells and synthesis of bacterial proteins </p>
