                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/hepaguard.png" alt="Hepaguard Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Hepaguard Injection</h1>
                                        </div>
                                        <p>For the treatment of all conditions associated with hepatic failure. Many are the therapeutic activities carried out on the liver: cholagogue effect, choleretic effect, analgesic and antispasmodic effects on the bile ducts.</p>
