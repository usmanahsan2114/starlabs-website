                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/cortinol-p.png" alt="Cortinol P Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Cortinol P Injection</h1>
                                        </div>
                                        <p>For treatment of inflammatory lid disease, conjunctivitis, episcleritis, anterior and posterior uveitis, optic neuritis and noninfectious orbital inflammation.</p>
