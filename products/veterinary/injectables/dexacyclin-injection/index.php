                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/dexacyclin.png" alt="Dexacyclin Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Dexacyclin Injection</h1>
                                        </div>
                                        <p>Dexacyclin is an ideal preparation of Oxytetracycline with Tripelennamine and Dexamethasone. Oxytetracycline is bacteriostatic at therapeutic levels but in higher concentrations it is bactericidal broad spectrum antibiotic both in vitro and in vivo</p>
