                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/mil-d-forte.png" alt="MID-D-Forte Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>MID-D-Forte Injection</h1>
                                        </div>
                                        <p>Mil-D-Forte Injection contains Calcium, Magnesium and Phosphorus Compounds and vitamins in a well balanced and well tolerated proportions. The said minerals play vital role in the growth and building up resistance against various infections overexertion. The vitamins make up deficiency of Vitamins of B Group and Nicotinamide which is essentially required for convalescence and supplement for poorly nutrient feeds. The deficiency of these elements in animals causes weakness, Milk fever, infertility and retarded growth.</p>
