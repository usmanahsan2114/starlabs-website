                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/tystar.png" alt="Tystar Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Tystar Injection </h1>
                                        </div>
                                        <p>Gentamicin is an aminoglycoside antibiotic indicated for the treatment of a variety of bacterial infections. it is normally used as the sulphate salt. in veterinary medicine gentamicin is used mainly as a solution for injection for sheep cattle and horses and as an oral solution for poultry.
                                        Tylosin is an antibiotic from macrolide group. to date tylosin tartrate is known to be the best remedy against mycoplasmosis. at higher dosed, it also acts against gram positive and gram-negative bacteria.k</p>
