                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/penci-la.png" alt="Pexcin-LA Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Pexcin-LA Injection </h1>
                                        </div>
                                        <p>For the treatment of Pneumonia, Pasteurellosis, Diarrhea, Mastitis, Uteritis, Leptospirosis, Erysipelas, Septicemia and other diseases caused by organism sensitive to penicillin or streptomycin</p>
