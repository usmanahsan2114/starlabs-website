                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/sanvil.png" alt="sanvil Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>sanvil Injection </h1>
                                        </div>
                                        <p>Used to treat allergic conditions, such as hayfever, runny nose, allergic conjunctivitis, rashes, serum sickness, food allergy, vasomotor rhinitis, acute rhinitis, and itching skin conditions, </p>
