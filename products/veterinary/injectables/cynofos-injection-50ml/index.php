                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/cynofos-50.png" alt="Cynofos Injection 50ml - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Cynofos Injection 50ml</h1>
                                        </div>
                                        <p>For the prevention and treatment of metabolic and nutritional disorders, weak- ness, fatigue, lactation tetany, post parturient paresis in large animals</p>
