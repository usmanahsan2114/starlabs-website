                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/almox-15.png" alt="Almox 15% LA Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Almox 15% LA Injection</h1>
                                        </div>
                                        <p> Urogenital tract diseases: Mastitis, metritis, pyometra, retained placenta, navel ill, cystitis, nephritis & MMA-syndrome etc</p>
