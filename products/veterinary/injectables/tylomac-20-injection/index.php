                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/tylomac-20.png" alt="Tylomac-20 Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Tylomac-20 Injection </h1>
                                        </div>
                                        <p>Tylomac-20 is a macrolide type of antibiotic having a large spectrum of activity gram-positive micro organisms. P.P.L.O, Some spirochetes hemophilus pertussis, erysipelothrix insidosia vibrio coli,moraxella bovis, some aviair coccidia and large viruses synovitis, sinusitis and omithosis in poultry. After parenteral administration therapeutic active blood concentrations of tylomac-20 are reached within 2 hours and maximum concetrations after 4 – 5 hours. The therapeutic blood levels are maintained for about 10 hours after the administration.</p>
