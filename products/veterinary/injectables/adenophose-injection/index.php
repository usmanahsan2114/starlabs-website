                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/adenophose.png" alt="Adenophose Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Adenophose Injection</h1>
                                        </div>
                                        <p> For muscular dystrophy in calves & lambs, placental retention, deforming syndrome in bavine and ovine. Reproduction in efficiay myocyles; myasthenia, neuritis and muscular fatigue.</p>
