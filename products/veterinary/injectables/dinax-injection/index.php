                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/dinax.png" alt="Dinax Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Dinax Injection</h1>
                                        </div>
                                        <p>For the treatment of bovine respiratory disease (BRD) associated with Mannheimia haemolytica and Pasteurella multocida in beef cattle and for the control of BRD in beef cattle at high risk of developing BRD associated with Mannheimia haemolytica and Pasteurella multocida.</p>
