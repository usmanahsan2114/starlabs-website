                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/sulpha-s.png" alt="sulpha-S Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>sulpha-S Injection </h1>
                                        </div>
                                        <p>Treating uncomplicated infections of the urinary tract, infections caused by Nocardia asteroids, streptococcal pharyngitis, menigococcal diseases, toxoplasmosis, and others.</p>
