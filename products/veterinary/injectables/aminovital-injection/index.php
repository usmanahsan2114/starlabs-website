                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/aminovital.png" alt="Aminovital Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            <p style="color:#db0000;"> <b>Veterinary</b> ~Injectables</p>
                                            <h1>Aminovital Injection</h1>
                                        </div>
                                        <p>Aminovital Injection is a combination of essential vitamins, amino acids and oligo elements. The deficiency of Vitamins is observed in various types of stock farming and the productivity under intense conditions requires extraordinary allowances. At the time of overcrowding,chang in temperature, microbial infections, parasitism, the supplement of vitamins play vital role. Aminoacids,through biological process take part in growth and maintenance cycles i.e. in the defence and reproductive functions. Minerals are recognized as bio-catalysts. Their presence in minor quantities is important for chemical reactions owing to which the multiple organics complexes of the living organisms are elaborated, distributed and balanced.</p>
