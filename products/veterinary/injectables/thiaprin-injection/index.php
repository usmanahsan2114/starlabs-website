                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/thiaprin.png" alt="Thiaprin Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Thiaprin Injection </h1>
                                        </div>
                                        <p>Thiaprin Injection is a very important biocatalyst which improves the production, performance and strength of intestinal bacterial flora damaged by prolonged antibiotic treatment. It is also useful for all domestic animals during the periods of stress and disease.</p>
