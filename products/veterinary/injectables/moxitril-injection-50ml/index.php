                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/moxitril-50.png" alt="Moxitril Injection 50ml - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Moxitril Injection 50ml</h1>
                                        </div>
                                        <p>Amoxicillin Trihydrate + Colistin Sulphate is a combination of two antibiotics. Amoxicillin is a penicillin antibiotic that works by inhibiting bacterial cell wall synthesis, while Colistin is a polymyxin antibiotic that disrupts the cell membrane of bacteria, leading to cell death. The combination of these two antibiotics is used to provide a broad spectrum of antimicrobial activity against a variety of bacteria.</p>
