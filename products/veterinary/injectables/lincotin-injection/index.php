                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/licotin.png" alt="Lincotin Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Lincotin Injection</h1>
                                        </div>
                                        <p>For preventing and treating respiratory tract and the digestive tract disease of domestic animal; Like disease, infectious arthritis, osteomyelitis, streptococcal infection, staphy lococcus infections etc.</p>
