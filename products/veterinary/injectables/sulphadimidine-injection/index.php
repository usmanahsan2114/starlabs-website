                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/sulphadimidine.png" alt="Sulphadimidine Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Sulphadimidine Injection </h1>
                                        </div>
                                        <p>Sulfadimidine acts usually bactericidal against many Gram-positive and Gram-negative microorganisms, like Corynebacterium, E.coli, Eimeria, Fusobacterium necrophorum, Pasteurella, Salmonella and Streptococcus spp. Sulfadimidine affect bacterial purine synthesis, as a result of which a blockade is accomplished.</p>
