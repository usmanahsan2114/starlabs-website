                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/gentalin-ts.png" alt="gentalin-TS Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>gentalin-TS Injection</h1>
                                        </div>
                                        <p>Gentamicin is an aminoglycoside antibiotic indicated for the treatment of a variety of bacterial infections. It is normally used as the sulphate salt. In veterinary medicine gentamicin is used mainly as a solution for injection for pigs, cattle and horses and as an oral solution for poultry</p>
