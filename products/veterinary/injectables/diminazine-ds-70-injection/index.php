                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/diminazine-ds-70.png" alt="Diminazine-DS-70 Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Diminazine-DS-70 Injection</h1>
                                        </div>
                                        <p>For the treatment and prophylaxis of Trypanosomiasis, Babesiosis, Theileriosis, Pyrexia of unknown origin and mixed haemoprotozoan infection</p>
