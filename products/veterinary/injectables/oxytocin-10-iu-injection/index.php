                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/oxytocin-10-iu.png" alt="Ocytocin-10 IU Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Ocytocin-10 IU Injection </h1>
                                        </div>
                                        <p>Oxytocin is a nonapeptide protein hormone which is produced endogenously in the hypothalamus.
                                        Oxytocin promotes contractions of the smooth muscular tissue from the oestrogen sensitised uterus and lacteal gland</p>
