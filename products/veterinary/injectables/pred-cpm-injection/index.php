                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/pred-cpm.png" alt="Pred CPM Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Pred CPM Injection </h1>
                                        </div>
                                        <p>Chlorpheniramine Maleate, an antihistamine that mitigates the body's response to allergens, and Prednisolone, a corticosteroid that aids in reducing inflammation and itching. </p>
