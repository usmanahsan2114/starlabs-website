                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/spiraline.png" alt="spiraline Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>spiraline Injection </h1>
                                        </div>
                                        <p>For the treatment of respiratory tract infections (RTIs) like pneumonia and mycoplasmosis, soft tissu infections, enteric infections, mastitis nephritis and arthritis in cattle, sheep goat and poultry.</p>
