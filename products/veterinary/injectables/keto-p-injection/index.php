                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/keto-p.png" alt="Keto-P Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Keto-P Injection</h1>
                                        </div>
                                        <p>For acute pain (up to 5 days) in both dogs and cats. In horses, it is used for pain and inflammation associated with osteoarthritis and for visceral pain associated with colic</p>
