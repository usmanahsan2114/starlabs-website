                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/injectables/tilmisin-30.png" alt="Tilmisin 30% Injection - Veterinary Injectables by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Tilmisin 30% Injection </h1>
                                        </div>
                                        <p>It is indicated for the treatment of respiratory infections in cattle and sheep associated with Mannheimia haemolytica, Pasteurella spp. and other tilmicosin-susceptible micro-organisms, and for the treatment of ovine mastitis associated with Staphylococcus aureus and Mycoplasma spp</p>
