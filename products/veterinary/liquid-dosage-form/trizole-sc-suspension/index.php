                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/trizole-sc-suspension.jpg" alt="Trizole SC suspension - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Trizole SC suspension</h1>
                                        </div>
                                        <p>Broad spectrum anthelmintic for the control and treatment of all type of round worms, liver flukes, tape worms, mature and immature nematodes</p>
