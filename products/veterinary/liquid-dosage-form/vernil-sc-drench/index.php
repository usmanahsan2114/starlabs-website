                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/vernil-sc-solution.jpg" alt="Vernil SC Drench - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            <p style="color:#db0000;"> <b>Veterinary</b> ~ Liquid Dosage Form</p>
                                            <h1>Vernil SC Drench</h1>
                                        </div>
                                        <p>Evamisole is a synthetic anthelmintic. After oral or parenteral administration, it first paralyses the worms and afterwards expel in the faeces. After parenteral application, within 30 minutes maximum blood concentrations are reached and most of the intestinal and lung nematodes are expelled within 24 hours. Levamisole is highly active against mature and immature lung worms and gastrointestinal nematodes of cattle, sheep, goats and other animals. In therapeutic doses Levamisole is nontoxic and no side effects are observed. After double dose restlessness and salivation may be noticed.</p>
