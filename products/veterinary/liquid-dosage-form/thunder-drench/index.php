                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/thunder-drench.jpg" alt="Thunder Drench - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Thunder Drench</h1>
                                        </div>
                                        <p>Highly effective against round worms, liver flukes, tape worms, brownstomach worms, bankrupt worms, thread worms, hook worms, nodular worms internally present in abomasom, small intestine, large bowl, lung & liver of cattle, sheep & goat.</p>
