                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/florfenic-20-oral-liquid.jpg" alt="Florfenic 20% Oral Liquid - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Florfenic 20% Oral Liquid</h1>
                                        </div>
                                        <p>For treatment of bovine respiratory disease (BRD) associated with Mannheimia haemolytica, Pasteurella multocida, and Histophilus somni, and for the treatment of bovine interdigital phlegmon (foot rot, acute interdigital necrobacillosis, infectious pododermatitis)</p>
