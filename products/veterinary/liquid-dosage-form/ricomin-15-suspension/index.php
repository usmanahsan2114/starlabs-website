                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/ricomin-15-suspension.jpg" alt="Ricomin 15% suspension - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Ricomin 15% suspension</h1>
                                        </div>
                                        <p>Acts on eggs sterilization and combats adult and immature forms of gastrointestinal and pulmonary nematodes, cestodes (flat worms) and trematodes (Fasciola hepatica)</p>
