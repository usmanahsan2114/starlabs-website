                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/peclin-s-oral-suspension.jpg" alt="Penclin S Oral Suspension - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Penclin S Oral Suspension</h1>
                                        </div>
                                        <p>Highly effective against a wide range of bacterial and protozoal organisms responsible for causing colibacillosis, salmonellosis, coccidiosis, enteritis, diarrhea in sheep, goat, cattle, horses, dogs and cats.</p>
