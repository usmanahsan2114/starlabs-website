                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/trizole-8.75-suspension.jpg" alt="Trizole 8.75% suspension - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Trizole 8.75% suspension</h1>
                                        </div>
                                        <p>For the treatment and control of parasitic gastroenteritis, bronchitis and all immature and adult stages of liver fluke in sheep and goat.</p>
