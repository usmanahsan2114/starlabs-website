                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/ceriflox-oral-solution.jpg" alt="Ceriflox Oral Solution - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Ceriflox Oral Solution</h1>
                                        </div>
                                        <p>To susceptible bacteria in a variety of species. Treatment has included infections of skin and soft tissue, urinary tract infections in dogs and cats, Chlamydophila felis infections in cats</p>
