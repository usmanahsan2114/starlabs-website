                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/zalvet-sc-suspension.jpg" alt="Zalvet Plus Suspension 4.5% - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Zalvet Plus Suspension 4.5%</h1>
                                        </div>
                                        <p>It is used in the treatment and control of fascioliasis in ruminants mainly domestic animals such as cattle, sheep, and goats</p>
