                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/toltrastar-plus-oral-solution.jpg" alt="Toltraster Plus Oral Solution - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Toltraster Plus Oral Solution</h1>
                                        </div>
                                        <p>Used to treat coccidiosis at all stages including the larval and adult stages of Eimeria spp. in chickens and turkeys.</p>
