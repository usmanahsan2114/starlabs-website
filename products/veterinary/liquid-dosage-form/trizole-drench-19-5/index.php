                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/trizole-19.5-suspension.jpg" alt="Trizole Drench 19.5% - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Trizole Drench 19.5%</h1>
                                        </div>
                                        <p>For the treatment and control of parasitic gastroenteritis, bronchitis and all immature and adult stages of liver fluke in cattle and buffalo.</p>
