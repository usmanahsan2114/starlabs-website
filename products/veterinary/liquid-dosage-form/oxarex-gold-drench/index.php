                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/oxarex-gold-drench.jpg" alt="Oxarex Gold Drench - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Oxarex Gold Drench</h1>
                                        </div>
                                        <p>Treatment and control of immature and mature gastrointestinal round worms, lung worms, tape worms and chronic fasciolosis in cattle, sheep and goat.</p>
