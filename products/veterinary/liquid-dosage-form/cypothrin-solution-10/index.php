                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/cypothrin-solution-10.jpg" alt="Cypothrin Solution 10% - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Cypothrin Solution 10%</h1>
                                        </div>
                                        <p>For disinsection and deacarization of cattle, sheep, goats, horses, donkeys, camels, poultry and other animals, protection of livestock facilities from harmful insects and ticks</p>
