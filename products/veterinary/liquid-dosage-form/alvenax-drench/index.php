                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/alvenax-drench.jpg" alt="Alvenax drench - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Alvenax drench</h1>
                                        </div>
                                        <p>To treat neurocysticercosis (infection caused by the pork tapeworm in the muscles, brain, and eyes that may cause seizures, brain swelling, and vision problems)</p>
