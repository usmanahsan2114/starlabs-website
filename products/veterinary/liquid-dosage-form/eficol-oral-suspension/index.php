                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/liquid-dosage-form/eficol-oral-suspension.jpg" alt="Eficol Oral Suspension - Veterinary Liquid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Eficol Oral Suspension</h1>
                                        </div>
                                        <p>For prevention and treatment of digestive and respiratory infections due to gram-negative micro-organisms particularly: E. coli, Salmonella, Pasteurella and Haemophillus</p>
