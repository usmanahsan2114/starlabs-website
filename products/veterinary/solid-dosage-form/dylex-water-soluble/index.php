                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/dylex-water-soluble.jpg" alt="Dylex Water Souble Powder (TAGAFON PLUS WS POWDER) - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Dylex Water Souble Powder 
                                            (TAGAFON PLUS WS POWDER)</h1>
                                        </div>
                                        <p>It is used orally, topically or parentally for the control of parasites in various animal species.</p>
