                            ...
                            <div class="row">
                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/flumine-bolus.jpg" alt="Flumine Bolus - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        ...
                                        <p>Used in veterinarian medicine for the treatment of enteric infections (all infections of the intestinal tract), as well as to treat cattle, swine, chickens, and fish</p>
