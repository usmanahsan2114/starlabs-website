                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/eg-grow-granules.jpg" alt="eg grow granules - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>eg grow granules</h1>
                                        </div>
                                        <p>Eg-Grow Granules is combination of three Calcium salts with Vitamin D and Vitamin K3, it accelerates growth, increases egg production and provides protection against poor structural development, low egg production and combats rickets and Osteomalacia. Chickens and other flocks having a Vitamin K3 deficiency suffer from haemorrhages (intra-abdominal haemorrhages, ovarian haemorrhages, cloacal or intestinal haemorrhages etc.) The addition of Vitamin K3 having blood clotting and antihaemorragic action, gives complete protection to poultry.</p>
