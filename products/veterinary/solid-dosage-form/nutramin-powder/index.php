                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/nutramin-powder.png" alt="Nutramin Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Nutramin Powder</h1>
                                        </div>
                                        <p>The scientific research has revealed that the living body and its parts and minerals contained in animal feed are composed of similar elements in their descriptions, the deficiency of which causes various diseases. NUTRAMIN POWDER is a well balanced combination of essential minerals which not only helps the livestock to combat the diseases but also increases production with milk and meat</p>
