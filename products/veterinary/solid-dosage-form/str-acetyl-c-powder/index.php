                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/str-acetyl-c-powder.jpg" alt="STR-Acetyl-C Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>STR-Acetyl-C Powder</h1>
                                        </div>
                                        <p>Vitamin C intervenes actively as hydrogen carrier in the cellular oxidation reduction process. It acts powerfully in the stimulation of endocrine secretions particularly in the suprarenal pituitary glands and ovary level. Vitamin C is essential for the resistance to various conditions such as infections toxicity, physical fatigue and over-exertion because of its role in the adoption syndrome. Moreover it has proved useful in allergies in growth symptoms and in the osseous tissue level. Acetyl Salicylic Acid is an analgesic and antipyretic which relieves from pains due to aggressive reactions.</p>
