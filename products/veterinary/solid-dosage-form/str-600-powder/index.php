                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/str-600-powder.jpg" alt="STR-600 Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>STR-600 Powder</h1>
                                        </div>
                                        <p>Prevention and treatment of bacterial infections of different origins (Staphylococci, E. Coli, Pasteurella, Salmonella) to prevent losses often occurring after transport, rehousing, change of feed, heat stress. For good performance and optimal results in animal production.</p>
