                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/tylovital-f-powder.jpg" alt="Tylovital-F Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Tylovital-F Powder</h1>
                                        </div>
                                        <p>Tylovital-F Powder is a combination of Antibiotics with vitamins. Tylosine and Erythromycin are broad spectrum antibiotic especially effective against infections of respiratory tract. Furaltadone has excellent bactericidal property, especially in the prevention and treatment of salmonellosis and pullorum diseases. Vitamins allow control of secondary effects resulting for the use of antibiotics and to meet a deficiency of respective vitamins.</p>
