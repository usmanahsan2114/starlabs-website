                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/coxifin-powder.jpg" alt="Coxifin Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Coxifin Powder</h1>
                                        </div>
                                        <p>Amprolium is an antiprotozoal agent and coccidiostatics. It is used for the treatment of enteric coccidiosis. Moreover it is also effective against first generation schizonts of developing coccidia. Vitamin A plays an important role in the protection of mucous membrance and also important for growth and laying eggs. Vitamin D3 takes care for regular process of calcium phosphorus metabolism. Vitamin K3 is essential in poultry particularly to stop haemorrhages </p>
