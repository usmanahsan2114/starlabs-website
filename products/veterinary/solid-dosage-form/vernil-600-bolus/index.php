                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/vernil-600-bolus.jpg" alt="Vernil 600 bolus - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Vernil 600 bolus</h1>
                                        </div>
                                        <p>Propylaxis and treatment of worm infections in calves, cattle, goats, and sheep-like gastrointestinal worms, lungworms, tapeworm.</p>
