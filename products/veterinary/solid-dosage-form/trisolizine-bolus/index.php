                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/trisolizine-bolus.jpg" alt="Trisolizine Bolus - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Trisolizine Bolus</h1>
                                        </div>
                                        <p>It is used for the treatment of bacterial infections in Calves, Cattle, Cows, Goats, Poultry and Sheep</p>
