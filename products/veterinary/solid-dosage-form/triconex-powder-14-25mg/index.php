                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/triconex-14.25powder.jpg" alt="Triconex Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Triconex Powder</h1>
                                        </div>
                                        <p>Triconex Powder is a combination of two antimicrobial agents, effective in wide range of intestinal infections caused by protozoa and bacteria in pigeons.
                                        Triconex is a drug of choice for the treatment and control of trichomoniasis, amoebiasis, and intestinal infections. Also it has an activity against tape worms.</p>
