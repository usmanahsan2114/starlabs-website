                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/aminovital-powder.jpg" alt="Aminovital Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Aminovital Powder</h1>
                                        </div>
                                        <p>Aminovital is a stable, water soluble, assimilable and well proportioned Vitamin complex. This product provides an efficient control of avitaminosis and nutritional imbalance and facilitates transition from one diet to another. It enables to react against the unfavourable environmental conditions. More-over, it constitutes an indispensable complement during infectious or parasitic disease.
                                        Vitamins are vitally required for making up deficiency due to poor nutrient feed. Aminoacids through combined biological processes aids in the maintenance of good health and performance and supports treatment of infectious diseases and helps to overcome stress situations.</p>
