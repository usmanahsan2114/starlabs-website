                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/avitone-powder.jpg" alt="Avitone Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Avitone Powder</h1>
                                        </div>
                                        <p>Avitone is a stable, water soluble, assimilable and well proportioned vitamins complex, which provides an efficient control of avitaminosis and nutritional imbalance. Avitone ensures a rapid growth, a maximum and well proportion and facilitates the transition front one diet to another. It enables to react against the unfavourable environmental changes (ie temperature, moisture etc.) moreover it constitutes an indispensable complement during infections or parasitic diseases.</p>
