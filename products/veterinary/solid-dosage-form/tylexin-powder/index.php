                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/tylexin-powder.jpg" alt="Tylexin Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Tylexin Powder</h1>
                                        </div>
                                        <p>For the treatment and prevention of CRD, CCRD, Fowl Cholera, Fowl Typhiodlnfectious Coryza, Bacterial Enterities. Early chick mortality and other Respiratory tract infections in large animals infection caused by Tylosin Doxyxcline Colistin 8L Bromhexine sensitive organism.</p>
