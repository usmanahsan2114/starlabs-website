                            ...
                            <div class="row">
                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/uronax-powder.jpg" alt="Uronax Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        ...
                                        <p>Each 100 gm contains:- Methenamine…95gm, Vitamin B1…800mg, Vitamin B2…920mg, Vitamin K3…200mg, Dextrose Anhydrous…3.80gm</p>
