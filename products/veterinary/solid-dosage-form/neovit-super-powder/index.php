                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/neovit-super-powder.jpg" alt="Neovit Super Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            <p style="color:#db0000;"> <b>Veterinary</b> ~ Solid Dosage Form</p>
                                            <h1>Neovit Super Powder</h1>
                                        </div>
                                        <p>Oxytetracycline HC1 and Neomycine Sulphate is a well balanced combination of the board spectrum antibiotic having efficiency against mainly all gram-positive and gram¬negative micro-organism. The penetration of oxytetracycline into the body is very good producing highly active concentration in blood and tissue. Neomycine is absorbed very poorly from the intestinal tract and therefore remain active in the whole length of intestines.
                                          In Neovit Super Powder: stable, water soluble, assimilable and proportioned Vitamin complex have been added, which provides an efficient control of avitaminosis and nutritional imbalance.
                                          Neovit super powder ensures a rapid growth, a maximum egg and meat production and facilitates the transition from one diet to another.</p>
