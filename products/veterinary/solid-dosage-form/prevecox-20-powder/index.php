                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/prevecox-20-powder.jpg" alt="Prevecox 20 Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Prevecox 20 Powder</h1>
                                        </div>
                                        <p>Amprolium is a coccidiostat (antiprotozoal) used for the treatment and prevention of coccidiosis in calves, sheep, goats, chickens (broilers and breeders) and other fowl such as turkeys, with activity against Eimeria spp., especially Eimeria tenella and Eimeria necatrix.</p>
