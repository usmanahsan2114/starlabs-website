                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/taradox-powder.jpg" alt="Taradox Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Taradox Powder</h1>
                                        </div>
                                        <p>For the treatment and prevention of C.R.D, C.C.R.D, Fowl Cholera, Fowl Typhoid, Infectious Coryza, Bacterial Enteritis, Early chick mortality and other Respiratory tract infections. In large animals infections caused by Tylosin, Doxycycline, Colistin & Bromhexine sensitive organisms.</p>
