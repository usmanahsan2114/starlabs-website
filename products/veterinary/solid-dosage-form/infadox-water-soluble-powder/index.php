                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/infadox-water-souble-powder.jpg" alt="Infadox Water Souble Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Infadox Water Souble Powder</h1>
                                        </div>
                                        <p>Gastrointestinal and respiratory infections caused by tylosin and doxycycline sensitive micro-organisms, like Bordetella, Campylobacter, Chlamydia, E. coli, Haemophilus, Mycoplasma, Pasteurella, Rickettsia, Salmonella, Staphylococcus, Streptococcus and Treponema spp. in calves, goats, poultry, sheep and swine.</p>
