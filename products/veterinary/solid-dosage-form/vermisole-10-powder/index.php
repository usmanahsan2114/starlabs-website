                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/vermisole-10-powder.jpg" alt="Vermisole 10% Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Vermisole 10% Powder</h1>
                                        </div>
                                        <p>A broad specttrum anthelmintic for the treatment & control of nematode infections, including tapeworms (syngasmus) common & large round worms (ascaride) pinworms (capillaria) caecal worms (heterakis) & metarakis & metastongylus.</p>
