                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/neo-oxy-30-powder.jpg" alt="Neo-oxy 30 Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Neo-oxy 30 Powder</h1>
                                        </div>
                                        <p>Sheep, cattle, dogs & goats: broad spectrum, high potency antibiotic for respiratory tract, g.i. Tract & urinary tract infections of gram positive and gram negative origin including certain fungi and protozoal infections</p>
