                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/nutravet-powder.jpg" alt="Nutravet Powder - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Nutravet Powder</h1>
                                        </div>
                                        <p>To assure adequate intake of vitamins and minerals during critical periods of animals life, vaccination, feed and housing changes, avitaminosis, as immunity system enhancer. Although specially designed for claves but can be given to any animal.</p>
