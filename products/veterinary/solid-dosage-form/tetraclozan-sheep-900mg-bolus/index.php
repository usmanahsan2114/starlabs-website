                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/solid-dosage-form/tetraclozan-sheep-900mg-bolus.jpg" alt="Tetraclozan Sheep 900 mg Bolus - Veterinary Solid Dosage Forms by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Tetraclozan Sheep 900 mg Bolus</h1>
                                        </div>
                                        <p>For the treatment & control of gastrointestinal & pulmonary nematode infection and chronic fascioliasiscaused by adult liver flukesin Sheep & Goats</p>
