                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/aerosal-spray/teragen.png" alt="Teragen aerosol spray - Veterinary Aerosols by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            ...
                                            <h1>Teragen  aerosol spray</h1>
                                        </div>
                                        <p>Infectious wounds, cuts and burn, foot rot and surgical operation.</p>
