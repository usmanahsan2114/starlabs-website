                                        ...
                                        <div class="tab-content" id="myTabContent2">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                                <div class="product-large-img">
                                                    <img src="../../../../img/product/veterinary/aerosal-spray/oxycort-spray.png" alt="Oxycort Spray - Veterinary Aerosols by Star Laboratories" loading="lazy" decoding="async">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="product-details mb-30">
                                        <div class="product-details-title">
                                            <p style="color:#db0000;"> <b>Veterinary</b> ~ Aerosal</p>
                                            <h1>Oxycort Spray</h1>
                                        </div>
                                        <p>For the treatment of bacterial infections such as respiratory tract infection, urinary tract infection, sexually transmitted diseases, skin infections, eye infections, gut infection, and another relatively rare kind of infections such as rickettsial infections</p>
